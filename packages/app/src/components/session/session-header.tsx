        ...
        {(mount) => (
          <Portal mount={mount()}>
            <Button
              ...
              variant="ghost"
              size="small"
              class="flex md:w-[240px] max-w-full min-w-0 items-center gap-2 justify-between rounded-md border border-border-weak-base bg-surface-panel shadow-none cursor-default"
            ...
            >
              ...
              <div class="hidden md:flex min-w-0 flex-1 items-center overflow-visible">
