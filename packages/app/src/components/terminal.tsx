...
const useTerminalUiBindings = (input: {
  ...
  // ghostty-web only handles wheel scrollback today. Native mobile users drag inside the terminal,
  // so translate that touch gesture to terminal scrollback and keep it out of the session scroller.
