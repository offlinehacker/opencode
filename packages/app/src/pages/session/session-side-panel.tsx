...
export function SessionSidePanel(props: {
  ...
  createEffect(() => {
    if (!props.forceOpen) setStore("expanded", false)
  })
        ...
        <Show when={open()}>
          <div class="size-full flex flex-col">
            <Show when={!isDesktop() && props.forceOpen}>
              <div class="flex shrink-0 items-center justify-end gap-1 border-b border-border-weaker-base bg-v2-background-bg-base px-2 py-1">
                <IconButtonV2
